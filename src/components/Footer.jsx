...
function Footer({ darkMode }) {
  return (
    <footer className={`py-8 transition-colors duration-300 ${darkMode ? 'bg-gray-800' : 'bg-gray-100'}`}>
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            <h3 className="text-xl font-bold mb-4">Khokhar Welfare Foundation</h3>
            <p className="mb-4">
              Empowering communities and transforming lives through compassion, innovation, and dedication.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">Donate</a></li>
              <li><a href="#" className="hover:text-blue-600 dark:hover:text-blue-400">Usage History</a></li>
          ...
          <div>
            ...
            <address className="not-italic space-y-2">
              <p>123 Humanitarian Street</p>
              <p>Karachi, Pakistan</p>
              <p>Email: info@khokharfoundation.org</p>
              <p>Phone: +92 300 1234567</p>
            </address>
          </div>
        </div>
        <div className="mt-8 pt-6 border-t border-gray-300 dark:border-gray-700 text-center">
          <p>&copy; {new Date().getFullYear()} Khokhar Welfare Foundation. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
